 ...
 * 
 ******************************************************************/
package com.juvenxu.mvnbook.account.impl;
...
public class AccountServiceImpl implements AccountService {
	 ...
	 * 生成验证码主键
	 * 
	 * @see com.juvenxu.mvnbook.account.service.AccountService#generateCaptchaKey()
	 *
	 * @return
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.juvenxu.mvnbook.account.service.AccountService#generateCaptchaImage(java.lang.String)
	 *
	 * @param captchaKey
	 * @return
	 * @throws AccountCaptchaException
	 ...
	 * 用户注册
	 * 
	 * @see com.juvenxu.mvnbook.account.service.AccountService#signUp(com.juvenxu.mvnbook.account.pojo.SignUpRequest)
	 *
	 * @param signUpRequest
	...
	public void signUp(SignUpRequest signUpRequest) throws AccountServiceException {
		try {
			...
			String link = signUpRequest.getActivateServiceUrl().endsWith("/") ? signUpRequest.getActivateServiceUrl() + activationId
	 ...
	 * 激活账户
	 * 
	 * @see com.juvenxu.mvnbook.account.service.AccountService#activate(java.lang.String)
	 *
	 ...
	 * 用户登录
	 * 
	 * @see com.juvenxu.mvnbook.account.service.AccountService#login(java.lang.String,
	 *      java.lang.String)
	 *
	 * @param id
	 * @param password
